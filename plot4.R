## this code creates and exports four graphs of Global Active Power, Voltage, Sub Metering, and Global Reactive Power over two days as a png file named plot4.png
...
with(hpc, {
  ...
  legend("topright",legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), fill = NULL, border = NULL, lty=c(1,1,1), lwd=c(1,1,1), col=c("black","blue","red"))
